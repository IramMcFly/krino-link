        ...
        <ModuleStyles.ChartCard title="Tendencia en Tiempo Real" icon={FaTachometerAlt}>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={datosEnTiempoReal} isAnimationActive={false} animationDuration={0}>
              ...
              />
              <Line type="monotone" dataKey="voltaje" stroke="#8884d8" strokeWidth={2} name="Voltaje (V)" dot={false} isAnimationActive={false} />
              <Line type="monotone" dataKey="corriente" stroke="#82ca9d" strokeWidth={2} name="Corriente (A)" dot={false} isAnimationActive={false} />
              <Line type="monotone" dataKey="temperatura" stroke="#ff7c7c" strokeWidth={2} name="Temperatura (°C)" dot={false} isAnimationActive={false} />
            </LineChart>
          </ResponsiveContainer>
